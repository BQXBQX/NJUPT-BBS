<template>
    ...
    <transition name="afterPage">
        <div class="nowAfterViewContainer" v-if="isActive === false">
            ...
            <textarea placeholder="说说你的想法吧" class="afterInput"></textarea>
        </div>
    </transition>
</template>
<script setup>
...
import UploadViewTop from "../uploadViewTop/uploadViewTop.vue";
